...
[auto-commit]: site:user-guide/daily-operations/#automatically-commit-and-push-changes-to-your-repo
[bash]: https://www.gnu.org/software/bash/
[choose]: https://github.com/twpayne/chezmoi/issues/new/choose
[completion-cmd]: site:reference/commands/completion/
[completion-fun]: site:reference/templates/functions/completion/
[fish]: https://fishshell.com/
[ignore]: site:reference/special-files/chezmoiignore/
[powershell]: https://learn.microsoft.com/en-us/powershell/
[scriptenv]: site:user-guide/use-scripts-to-perform-actions/#set-environment-variables
[zsh]: https://zsh.sourceforge.io/
[flatpak]: https://flatpak.org/
[doctor]: site:reference/commands/doctor/
